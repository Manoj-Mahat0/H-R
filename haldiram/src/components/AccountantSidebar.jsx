// AccountantSidebar.jsx (dark/light friendly + theme toggle)
import React, { useEffect, useState } from "react";
import { Link, useLocation, useNavigate } from "react-router-dom";
import { useAuth } from "../context/AuthContext";
import {
  FiHome, FiTrendingUp, FiFileText, FiUsers, FiUser, FiLogOut, FiChevronLeft, FiList, FiSun, FiMoon
} from "react-icons/fi";
  ...
  return (
    <>
      ...
      <aside
        ...
        ${collapsed ? "w-20" : "w-72"} h-screen sticky top-0 bg-white dark:bg-gray-900 border-r dark:border-gray-800 border-gray-100 shadow-sm`}
      >
        <SidebarInner
          collapsed={collapsed}
          onToggleCollapse={toggleCollapse}
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className={`flex items-center gap-3 px-4 py-4 border-b ${compact ? "justify-center" : ""} border-gray-100 dark:border-gray-800`}>
        ...
        {!compact && (
          <div>
            <div className="text-sm font-semibold text-gray-900 dark:text-gray-100">Accountant Panel</div>
  ...
  return (
    <Link
      ...
      className={`group flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium transition-colors
        ${active ? "bg-gradient-to-r from-blue-50 to-blue-100 text-blue-700 dark:from-blue-900 dark:to-blue-800 dark:text-blue-300" : "text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800"}`}
    >
      <div className={`flex items-center justify-center h-9 w-9 rounded-md ${active ? "bg-blue-100 text-blue-600 dark:bg-blue-800 dark:text-blue-300" : "bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 group-hover:bg-gray-200 dark:group-hover:bg-gray-700"}`}>
