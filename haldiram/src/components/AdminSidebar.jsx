  ...
  const nav = useMemo(
    () => [
      ...
      },
      {
        ...
        icon: FiTruck,
        children: [
          { to: "/admin/vehicles", label: "All vehicles", icon: FiTruck },
          { to: "/admin/vehicles/add", label: "Add vehicle", icon: FiTruck },
        ],
      },
      {
        to: "/admin/customers",
        ...
        icon: FiUsers,
        children: [
          { to: "/admin/customers", label: "All Users", icon: FiUsers },
          { to: "/admin/customers/add-limits", label: "Add Limits", icon: FiUsers },
          { to: "/admin/attandance", label: "Attendance", icon: FiUsers },
        ],
      },
  ...
  return (
    <div className="h-full flex flex-col text-gray-800 dark:text-gray-200" ref={containerRef}>
      ...
      <div className={`flex items-center gap-3 px-4 py-4 border-b border-gray-100 dark:border-gray-800 ${compact ? "justify-center" : ""}`}>
        ...
        {!compact && (
          <div>
            <div className="text-sm font-semibold text-gray-900 dark:text-gray-100">Admin</div>
